...
ENV_VARS="Variables={TELEGRAM_BOT_TOKEN=$TELEGRAM_BOT_TOKEN,TELEGRAM_CHAT_ID=$TELEGRAM_CHAT_ID,ANTHROPIC_API_KEY=$ANTHROPIC_API_KEY,REPORT_LAMBDA_NAME=$REPORT_LAMBDA,DEPLOY_ID=$DEPLOY_ID,AWS_REGION=$REGION}"
